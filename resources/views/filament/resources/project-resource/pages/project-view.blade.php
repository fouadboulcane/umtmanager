...
<div class="px-4  sm:px-0">
    <div class="h-96 rounded-lg border-4 border-dashed border-gray-200">
        <div class="h-full text-center flex flex-col justify-center align-center w-32">
            {{-- <button class="filament-button filament-button-size-md inline-flex items-center justify-center py-1 gap-1 font-medium rounded-lg border transition-colors focus:outline-none focus:ring-offset-2 focus:ring-2 focus:ring-inset dark:focus:ring-offset-0 min-h-[2.25rem] px-4 text-sm text-white shadow focus:ring-white border-transparent bg-primary-600 hover:bg-primary-500 focus:bg-primary-700 focus:ring-offset-primary-700 filament-page-button-action" wire:click="mountAction(&#039;createProject&#039;)" dusk="filament.admin.action.createProject">
                            
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="animate-spin filament-button-icon w-5 h-5 mr-1 -ml-2 rtl:ml-1 rtl:-mr-2" x-cloak="x-cloak" wire:loading.delay="wire:loading.delay" wire:target="mountAction(&#039;createProject&#039;)">
            ...
            <path d="M2 12C2 6.47715 6.47715 2 12 2V5C8.13401 5 5 8.13401 5 12H2Z" fill="currentColor"></path>
                ...
                <span class="flex items-center gap-1"><span class=""> Add Widget</span></span>
...
<?php 
    $members = $record->tasks->map(function($task) {
        return $task->assignedMember;
    })->unique();
    // dd($members);
?>
